...
import com.sinam7.studywithkookmin.security.dto.OAuthAttributes;
import com.sinam7.studywithkookmin.security.dto.SessionUser;
import com.sinam7.studywithkookmin.entity.User;
import com.sinam7.studywithkookmin.repository.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // User 클래스를 사용하지 않고 SessionUser 클래스를 사용하는 이유는 오류 방지.
